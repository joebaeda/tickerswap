...
export default function Home() {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-gray-50 overflow-auto">
      ...
      >
        {isPlaying ? <svg width="40" height="40" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        </svg> : <svg width="40" height="40" viewBox="-0.5 0 25 25" xmlns="http://www.w3.org/2000/svg">
