export default function Disclaimer() {
    return (
        <div className="overflow-y-auto text-gray-500 max-h-90 p-4 shadow-lg max-w-lg w-full rounded-2xl border bg-gray-100 border-gray-200 font-mono custom-scroll">
            <h2 className="text-xl text-center py-6 font-bold border-b-2">Disclaimer</h2>
            <p className="pt-6">
