        ...
        <div className="fixed -bottom-4">
            ...
            >
                <svg width="300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <text x="54%" y="25%" dominantBaseline="middle" fontFamily="monospace" textAnchor="middle" fontSize="29" fontWeight="bold" fill="#fff">Install Wallet</text>
                    <text x="45%" y="63%" dominantBaseline="middle" fontFamily="monospace" textAnchor="middle" fontSize="29" fontWeight="bold" fill="#fff">Install Wallet</text>
                </svg>
